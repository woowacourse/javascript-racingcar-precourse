...
**추가 사항**
- [ ] 쉼표를 기준으로 자동차 이름을 구분합니다.
- [ ] 각 자동차의 이름은 최대 5자 이하입니다.
- [ ] 입력 값이 잘못되었다면 alert을 출력하고 focus합니다.
  - [ ] 이름의 양 끝에 공백이 들어갈 순 없습니다. 즉 문자 중앙에는 들어가도 됩니다.
  - [ ] 이름이 없을 수는 없습니다.
  - [ ] 중복된 이름이 있으면 안됩니다.
  - [ ] alert은 최초 입력 값과 비교한 뒤 포괄적으로 출력(`옳지 못한 입력값입니다. ...`)하며, 추후 리팩토링이 가능하다면 진행합니다.
