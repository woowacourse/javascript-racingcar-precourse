...
- 초기화시 elements hidden, visuable 메소드
- 차 이름 입력 텍스트 유효성 검사
- 차 이름 submit button action 메소드
- 레이싱 횟수 입력 텍스트 유효성 검사
- 레이싱 횟수 submit button action 메소드
- 차 객체 생성 메소드
- 차 객체 리스트 생성 메소드
- 랜덤 수 생성 메소드
- 한 번의 레이싱 진행 메소드
- 한 번의 레이싱 결과를 element로 추가하는 메소드
- 전체 레이싱 진행 메소드
- 경기 결과 계산하는 메소드
- 경기 결과를 element로 추가하는 메소드
