export const RACING_WINNERS_TEXT = '최종 우승자: ';
export const USER_ALERT_NO_NAME = '자동차 이름을 입력하세요.';
export const USER_ALERT_NO_COMPETITOR =
  '경기를 진행할 상대 자동차가 존재하지 않습니다.';
export const USER_ALERT_NO_COMMA = '자동차 이름은 쉼표로 구분해주세요.';
