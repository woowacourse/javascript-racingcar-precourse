export const addIdToElements = () => {
  const [carNamesInput, racingCountInput] = document.getElementsByTagName('input');
  const [carNamesSubmit, racingCountSubmit] = document.getElementsByTagName('button');
...
const addIdToChildren = () => {
  const childrenOfCarGameContainer = document.querySelector('.car-game-container').children;
