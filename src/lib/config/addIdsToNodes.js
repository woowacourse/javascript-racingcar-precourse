...
const addIdsToInputCarNamesNode = () => {
  const [$carNamesInput] = document
    .querySelector("#car-names-container")
    .getElementsByTagName("input");
  const [$carNamesSubmit] = document
    .querySelector("#car-names-container")
...
const addIdsToInputGetRacingCountNode = () => {
  const [$racingCountInput] = document
    .querySelector("#racing-count-container")
    .getElementsByTagName("input");
  const [$racingCountSubmit] = document
    .querySelector("#racing-count-container")
    .getElementsByTagName("button");
