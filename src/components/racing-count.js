...
export class RacingCount {
    constructor(setCount) {
        ...
        this.$countSubmitButton = document.getElementById(SELECTOR.ID.RACING_COUNT_SUBMIT);
        this.setCount = setCount;
        this.bindEvents();
    }
    bindEvents() {
        this.$countSubmitButton.addEventListener("click", this.submitCount.bind(this));
    }
    submitCount(event) {
